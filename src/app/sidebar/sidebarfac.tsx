...
import Roomfac from '../component/roomfac';

const Sidebarfac: React.FC = () => {
            ...
            <div className="flex h-screen bg-gray-50 ">
                <aside className="z-20 hidden w-64 overflow-y-auto md:block flex-shrink-0 h-screen " style={{ backgroundColor: '#003C43' }}>
                    <div className="py-4 text-gray-400 ">
                        ...
                        <ul>
                            <li className="relative px-6 py-3">
                                <Link href="../status" className="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
