...
import Cek from '../component/resepsionis/cek';

const Sidebarcekin: React.FC = () => {
                    ...
                    <div className="py-4 text-gray-400 ">
                        ...
                        <ul>
                            ...
                            <span className="absolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg" aria-hidden="true" style={{ backgroundColor: '#77B0AA' }}></span>
                                <Link href="../cekin" className="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                            ...
                            <li className="relative px-6 py-3">
                                <Link href="../sts" className="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                            ...
                            <li className="relative px-6 py-3">
                                <Link href="../fnb" className="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
